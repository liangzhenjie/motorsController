...
static quint16 CRC16_1(uchar* pchMsg, qint16 wDataLen)
{
    uchar chCRCHi = 0xFF; // 高CRC字节初始化
    uchar chCRCLo = 0xFF; // 低CRC字节初始化
    qint16 wIndex;            // CRC循环中的索引
    while (wDataLen--)
    {
        // 计算CRC
...
public:
    ...
    void AddProxyEnd();
    void AddProxyBegin(const quint8 nMode,const quint8 nDeviceId);
    bool CheckData();
    void AddCRCCode(qint16 nLen);
public:
    IData();
    IData(const QByteArray & buf);
    virtual ~IData() {}
