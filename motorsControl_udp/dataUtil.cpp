...
DataUtil::DataUtil()
{
    ...
    readDataMap.insert(D_READ_INVERTER_TEMP_PROTECT,MotorData::INVERTER_PROTECTED_TEMP);
    readDataMap.insert(D_READ_INVERTER_TEMP_RECOVERY,MotorData::INVERTER_RECOVERY_TEMP);
    setDataMap.insert(D_SET_INVERTER_TEMP_PROTECT,MotorData::INVERTER_PROTECTED_TEMP);
    setDataMap.insert(D_SET_INVERTER_TEMP_RECOVERY,MotorData::INVERTER_RECOVERY_TEMP);
